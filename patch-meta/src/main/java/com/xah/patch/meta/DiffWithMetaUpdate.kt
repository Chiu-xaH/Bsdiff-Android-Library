package com.xah.patch.meta

import android.content.Context
import android.widget.Toast
import com.bsdiff.core.BsdiffJni
import com.xah.patch.meta.model.PatchWithMeta
import com.xah.patch.meta.model.PatchWithMetaContent
    ...
    suspend fun merge (
        ...
        if (!checkResult) {
            ...
            return@withContext DiffResult.Error(
                DiffError(
                    DiffErrorCode.MD5_MISMATCH,
                    "Check md5 expected ${patchContent.meta.source.md5} but actually ${
                        getMd5(
                            targetFile
                        )
                    }"
